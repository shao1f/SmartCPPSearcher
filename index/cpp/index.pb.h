...
// required uint32 DocId = 1;
inline bool DocInfo::has_docid() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DocInfo::set_has_docid() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DocInfo::clear_has_docid() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DocInfo::clear_docid() {
  docid_ = 0u;
  clear_has_docid();
}
inline ::google::protobuf::uint32 DocInfo::docid() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.DocInfo.DocId)
  return docid_;
}
inline void DocInfo::set_docid(::google::protobuf::uint32 value) {
  set_has_docid();
  docid_ = value;
  // @@protoc_insertion_point(field_set:doc_index_proto.DocInfo.DocId)
}
...
inline ::google::protobuf::uint32 Weight::doc_id() const {
  // @@protoc_insertion_point(field_get:doc_index_proto.Weight.doc_id)
  return doc_id_;
}
inline void Weight::set_doc_id(::google::protobuf::uint32 value) {
  set_has_doc_id();
  doc_id_ = value;
